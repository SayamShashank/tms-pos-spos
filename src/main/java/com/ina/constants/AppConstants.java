...
public class AppConstants {
    ...
    public static final String MDC_IN_REF_ID = "inRefId";

    public static final String MDC_DEVICE_ID = "dId";
    ...
    public static final String NAME_SPACE="urn:iso:std:iso:20022:tech:xsd:catm.001.001.08";
}
